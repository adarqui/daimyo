...
-- | inOrder
--
-- >>> inOrder (fromList [1,5,2,7,3,8,1,3,2] :: Tree Int)
-- [1,1,2,2,3,3,5,7,8]
--
inOrder :: Tree a -> [a]
inOrder Empty        = []
...
-- | insert
--
-- >>> insert 1 (fromList [1,2,3,1,2,3] :: Tree Int)
-- Node 3 (Node 2 (Node 1 (Node 1 (Node 1 Empty Empty) Empty) (Node 2 Empty Empty)) (Node 3 Empty Empty)) Empty
--
